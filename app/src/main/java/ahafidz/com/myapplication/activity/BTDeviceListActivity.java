...
public class BTDeviceListActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ColorDrawable colorDrawable = new ColorDrawable(ResourcesCompat.getColor(getResources(), R.color.primary, null));
        ab.setBackgroundDrawable(colorDrawable);
        ab.setDisplayHomeAsUpEnabled(true);
        ab.setDisplayShowHomeEnabled(true);
        ab.setIcon(new ColorDrawable(ResourcesCompat.getColor(getResources(), android.R.color.transparent, null)));
    ...
    protected void onListItemClick(ListView l, View v, final int position,
        ...
        bluetoothName = btDevices.getItem(position).getName();
            ...
            public void run() {
                try {
                    ...
                    try {
                        ...
                        mbtSocket.connect();
                        Log.e("","Connected");
                        runOnUiThread(socketSuccessRunnable);
                    }
                    catch (Exception e2) {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            intent.putExtra("printer_name",bluetoothName);
    ...
    private Runnable socketSuccessRunnable = new Runnable() {

        @Override
        public void run() {
            Toast.makeText(getApplicationContext(),
                    "Connected to " + bluetoothName , Toast.LENGTH_SHORT).show();
